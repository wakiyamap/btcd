...
(http://godoc.org/github.com/wakiyamap/monad/peer)
...
```bash
$ go get -u github.com/wakiyamap/monad/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/wakiyamap/monad/peer#example-package--NewOutboundPeer)  
