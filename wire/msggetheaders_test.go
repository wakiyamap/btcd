...
func TestGetHeadersWireErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{baseGetHeaders, baseGetHeadersEncoded, pver, wire.BaseEncoding, 0, io.ErrShortWrite, io.EOF},
		// Force error in block locator hash count.
		{baseGetHeaders, baseGetHeadersEncoded, pver, wire.BaseEncoding, 4, io.ErrShortWrite, io.EOF},
		// Force error in block locator hashes.
		{baseGetHeaders, baseGetHeadersEncoded, pver, wire.BaseEncoding, 5, io.ErrShortWrite, io.EOF},
		// Force error in stop hash.
		{baseGetHeaders, baseGetHeadersEncoded, pver, wire.BaseEncoding, 69, io.ErrShortWrite, io.EOF},
		// Force error with greater than max block locator hashes.
		{maxGetHeaders, maxGetHeadersEncoded, pver, wire.BaseEncoding, 7, wireErr, wireErr},
	}
