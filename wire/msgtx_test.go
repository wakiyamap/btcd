...
func TestTx(t *testing.T) {
	...
	txIn := wire.NewTxIn(prevOut, sigScript, witnessData)
	...
	if !reflect.DeepEqual(txIn.Witness, wire.TxWitness(witnessData)) {
...
func TestWTxSha(t *testing.T) {
	...
	wantHashTxid, err := wire.NewShaHashFromStr(hashStrTxid)
	if err != nil {
