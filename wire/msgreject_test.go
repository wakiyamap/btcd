...
func TestRejectCrossProtocol(t *testing.T) {
	...
	readMsg := wire.MsgReject{}
	err = readMsg.BtcDecode(&buf, wire.RejectVersion-1, wire.BaseEncoding)
	if err == nil {
		t.Errorf("encode of MsgReject succeeded when it shouldn't "+
			"have %v", msg)
	}
...
func TestRejectWireErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{baseReject, baseRejectEncoded, pver, wire.BaseEncoding, 0, io.ErrShortWrite, io.EOF},
		// Force error in reject code.
		{baseReject, baseRejectEncoded, pver, wire.BaseEncoding, 6, io.ErrShortWrite, io.EOF},
		// Force error in reject reason.
		{baseReject, baseRejectEncoded, pver, wire.BaseEncoding, 7, io.ErrShortWrite, io.EOF},
		// Force error in reject hash.
		{baseReject, baseRejectEncoded, pver, wire.BaseEncoding, 23, io.ErrShortWrite, io.EOF},
		// Force error due to unsupported protocol version.
		{baseReject, baseRejectEncoded, pverNoReject, wire.BaseEncoding, 6, wireErr, wireErr},
	}
