...
func TestVersion(t *testing.T) {
	...
	tcpAddrMe := &net.TCPAddr{IP: net.ParseIP("127.0.0.1"), Port: 9401}
	me := NewNetAddress(tcpAddrMe, SFNodeNetwork)
	tcpAddrYou := &net.TCPAddr{IP: net.ParseIP("192.168.0.1"), Port: 9401}
...
func TestVersionOptionalFields(t *testing.T) {
	...
	uaVersion.UserAgent = "/monatest:0.0.1/"
...
var baseVersionEncoded = []byte{
	...
	0xf0, 0x83, 0xc2, 0x52, 0x00, 0x00, 0x00, 0x00, // 64-bit Timestamp
	// AddrYou -- No timestamp for NetAddress in version message
	0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // SFNodeNetwork
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0xff, 0xff, 0xc0, 0xa8, 0x00, 0x01, // IP 192.168.0.1
	0x24, 0xb9, // Port 9401 in big-endian
	...
	0x2f, 0x6d, 0x6f, 0x6e, 0x61, 0x74, 0x65, 0x73,
