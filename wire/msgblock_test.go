...
func TestBlockWireErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{&blockOne, blockOneBytes, pver, wire.BaseEncoding, 0, io.ErrShortWrite, io.EOF},
		// Force error in prev block hash.
		{&blockOne, blockOneBytes, pver, wire.BaseEncoding, 4, io.ErrShortWrite, io.EOF},
		// Force error in merkle root.
		{&blockOne, blockOneBytes, pver, wire.BaseEncoding, 36, io.ErrShortWrite, io.EOF},
		// Force error in timestamp.
		{&blockOne, blockOneBytes, pver, wire.BaseEncoding, 68, io.ErrShortWrite, io.EOF},
		// Force error in difficulty bits.
		{&blockOne, blockOneBytes, pver, wire.BaseEncoding, 72, io.ErrShortWrite, io.EOF},
		// Force error in header nonce.
		{&blockOne, blockOneBytes, pver, wire.BaseEncoding, 76, io.ErrShortWrite, io.EOF},
		// Force error in transaction count.
		{&blockOne, blockOneBytes, pver, wire.BaseEncoding, 80, io.ErrShortWrite, io.EOF},
		// Force error in transactions.
		{&blockOne, blockOneBytes, pver, wire.BaseEncoding, 81, io.ErrShortWrite, io.EOF},
	}
	...
	tests := []struct {
		...
		// Block that claims to have ~uint64(0) transactions.
		{
			[]byte{
				...
				0xff, // TxnCount
			}, pver, wire.BaseEncoding, &wire.MessageError{},
		},
	}
...
// TODO(roasbeef): TestSerializeSizeWitness
