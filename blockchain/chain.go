...
// already there.
func dbMaybeStoreBlock(dbTx database.Tx, block *monautil.Block) error {
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) connectBlock(node *blockNode, block *monautil.Block, view *UtxoViewpoint, stxos []spentTxOut) error {
...
type IndexManager interface {
	...
	// main chain.
	ConnectBlock(database.Tx, *monautil.Block, *UtxoViewpoint) error

	// DisconnectBlock is invoked when a block has been disconnected from
	// the main chain.
	DisconnectBlock(database.Tx, *monautil.Block, *UtxoViewpoint) error
}
