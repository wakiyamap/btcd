...
//
// This function is safe for concurrent access.
// TODO(roasbeef): add lock time flags? in place of mempool?
// TODO(roasbeef): extract header time fetching into call callback?
...
func LockTimeToSequence(isSeconds bool, locktime uint32) uint32 {
	...
	// corresponding sequence number if simply the desired input age.
	if !isSeconds {
		return locktime
	}
	...
	return RelativeLockSeconds | uint32(locktime>>RelativeLockSecondsGranularity)
}
